...
public class Main {
	...
	public static void main(String[] args) {
		...
		//----------------------------------------------------
		String prompt = "Please enter the name of the file from which to read the cars.";
		String filename = MyStringsClass.askUserForString(prompt);
		//-------------------------------------------
		...
		// specified data file.
		//-------------------------------------------
		CarLot currentCars = new CarLot(filename);
